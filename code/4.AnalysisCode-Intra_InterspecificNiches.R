...
# add individual data points
stripchart(del13C_permil ~ Species, data=iso_rabbits, vertical=TRUE, add=TRUE, method="jitter", col=c("gold1","red1"), pch=16)
mtext(expression({delta}^13*C~'value ('~'\u2030'~', VPDB)'), side=2, line = 2.25)
...
# add individual data points
stripchart(del15N_permil ~ Species, data=iso_rabbits, vertical=TRUE, add=TRUE, method="stack", pch=16, col=c("gold1","red1"))
mtext(expression({delta}^15*N~'value ('~'\u2030'~', AIR)'), side=2, line = 2.25)
...
carbon.lm.all.interaction<-lm(del13C_permil~pach.d18O_mean * Taxon, data=iso_dat)
...
carbon.lm.all<-lm(del13C_permil~pach.d18O_mean + Taxon, data=iso_dat)
summary(carbon.lm.all)

# climate-only model
carbon.lm.clim<-lm(del13C_permil~pach.d18O_mean, data=iso_dat)
summary(carbon.lm.clim)

# taxon-only model
carbon.lm.taxon<-lm(del13C_permil~Taxon, data=iso_dat)
summary(carbon.lm.taxon)

#stepwise regression 
carbon.lm.final <- step(lm(del13C_permil~pach.d18O_mean*Taxon, data=iso_dat, direction="both"))
...
# model with interaction term included
nitrogen.lm.all.interaction<-lm(del15N_permil~pach.d18O_mean * Taxon, data=iso_dat)
summary(nitrogen.lm.all.interaction)

# model with no interaction term 
nitrogen.lm.all.additive<-lm(del15N_permil~pach.d18O_mean + Taxon, data=iso_dat)
summary(nitrogen.lm.all.additive)

# climate-only model
nitrogen.lm.clim<-lm(del15N_permil~pach.d18O_mean, data=iso_dat)
summary(nitrogen.lm.clim)

# taxon-only model
nitrogen.lm.taxon<-lm(del15N_permil~Taxon, data=iso_dat)
summary(nitrogen.lm.taxon)

#stepwise regression --> this shows that there is not a good final model
nitrogen.lm.final <- step(lm(del15N_permil~pach.d18O_mean*Taxon, data=iso_dat, direction="both"))
...
# carbon
plot(del13C_permil~pach.d18O_mean, data=iso_dat, pch=16, type="n", xlab="", ylab="")
points(del13C_permil~pach.d18O_mean, 
...
abline(lm(del13C_permil~pach.d18O_mean, data=iso_dat), lty=1)
...
# nitrogen
plot(del15N_permil~pach.d18O_mean, data=iso_dat, pch=16, 
     xlab = "", ylab = "", type="n")
points(del15N_permil~pach.d18O_mean, 
       data=iso_dat[which(iso_dat$Taxon == "Sylvilagus "),], 
       pch=16, col="orange")
points(del15N_permil~pach.d18O_mean, 
       data=iso_dat[which(iso_dat$Taxon == "Otospermophilus"),], 
...
abline(lm(del15N_permil~pach.d18O_mean, data=iso_dat), lty=1)
...
plot(del13C_permil~pach.d18O_mean, data=iso_dat, pch=16, 
     xlab = expression({delta}^18*O~'\u2030', ), ylab = expression({delta}^13*C~'\u2030'), type="n")
points(del13C_permil~pach.d18O_mean, data=iso_dat[which(iso_dat$Taxon == "Sylvilagus "),], pch=16, col="orange")
points(del13C_permil~pach.d18O_mean, data=iso_dat[which(iso_dat$Taxon == "Otospermophilus"),], pch=16, col="royalblue2")
abline(carbon.lm.final)
abline(lm(del13C_permil~pach.d18O_mean, data=iso_dat), lty=2, col="red")
legend("bottomleft", legend = c("Otospermophilus", "Sylvilagus"),
       col = c("royalblue2","orange"), pch = 16, 
       bty = "n", cex = 0.8)
dev.off()
...
points(del15N_permil~pach.d18O_mean, data=iso_dat[which(iso_dat$Taxon == "Sylvilagus "),], pch=16, col="orange")
points(del15N_permil~pach.d18O_mean, data=iso_dat[which(iso_dat$Taxon == "Otospermophilus"),], pch=16, col="royalblue2")
carbon.lm<-lm(del15N_permil~pach.d18O_mean, data=iso_dat)
summary(carbon.lm)
abline(lm(del15N_permil~pach.d18O_mean, data=iso_dat))
dev.off()

ccf(data0$pach.d18O_mean, data0$del15N_permil)
...
p<-ggplot(data0, aes(Calibrated_mean_age, pach.d18O_mean)) +
  geom_line(aes(y = a + del15N_permil*b), color = "red") +
  geom_line(aes(y = pach.d18O_mean), color = "blue") +
...
plot(del13C_permil[Taxon=='Otospermophilus']~pach.d18O_mean[Taxon=='Otospermophilus'], 
     xlab = expression({delta}^18*O~'\u2030', ), ylab = expression({delta}^13*C~'\u2030'),
     data=iso_dat, pch=16, col="royalblue2")
carbon.lm<-lm(del13C_permil[Taxon=='Otospermophilus']~pach.d18O_mean[Taxon=='Otospermophilus'], data=iso_dat)
summary(carbon.lm)
abline(lm(del13C_permil[Taxon=='Otospermophilus']~pach.d18O_mean[Taxon=='Otospermophilus'], data=iso_dat))
dev.off()

#ccf(iso_dat$pach.d18O[Taxon=='O. beecheyi'], iso_dat$del13C_permil[Taxon=='O. beecheyi'])

#nitrogen and climate
pdf("output/Isoplots/lm_nitrogen_Oto.pdf", width=5, height=4)
plot(del15N_permil[Taxon=='Otospermophilus']~pach.d18O_mean[Taxon=='Otospermophilus'], 
     xlab = expression({delta}^18*O~'\u2030', ), ylab = expression({delta}^15*N~'\u2030'), 
     data=iso_dat, pch=16, col="royalblue2")
carbon.lm<-lm(del15N_permil[Taxon=='Otospermophilus']~pach.d18O_mean[Taxon=='Otospermophilus'], data=iso_dat)
summary(carbon.lm)
abline(lm(del15N_permil[Taxon=='Otospermophilus']~pach.d18O_mean[Taxon=='Otospermophilus'], data=iso_dat))
dev.off()
...
C<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del13C_permil*b), color = "brown", data=subset(data0,Taxon=="O. beecheyi")) +
...
n<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del15N_permil*b), color = "red", data=subset(data0,Taxon=="O. beecheyi")) +
  geom_line(aes(y = pach.d18O), color = "blue", data=subset(data0,Taxon=="O. beecheyi")) +
  scale_y_reverse("d18O Neogloboquadrina pachyderma", sec.axis = sec_axis(~ (. - a)/b, name = expression({delta}^15*N~'\u2030'))) +
  scale_x_reverse("Calibrated Years Before Present")+
...
plot(del13C_permil[Taxon=='Sylvilagus ']~pach.d18O_mean[Taxon=='Sylvilagus '], 
     xlab = expression({delta}^18*O~'\u2030', ), ylab = expression({delta}^13*C~'\u2030'),
     data=iso_dat, pch=16, col="orange")
carbon.lm<-lm(del13C_permil[Taxon=='Sylvilagus ']~pach.d18O_mean[Taxon=='Sylvilagus '], data=iso_dat)
summary(carbon.lm)
abline(lm(del13C_permil[Taxon=='Sylvilagus ']~pach.d18O_mean[Taxon=='Sylvilagus '], data=iso_dat))
dev.off()

#nitrogen and climate
pdf("output/Isoplots/lm_nitrogen_Syl.pdf", width=5, height=4)
plot(del15N_permil[Taxon=='Sylvilagus ']~pach.d18O_mean[Taxon=='Sylvilagus '], 
     xlab = expression({delta}^18*O~'\u2030', ), ylab = expression({delta}^15*N~'\u2030'),
     data=iso_dat, pch=16, col="orange")
nitrogen.lm<-lm(del15N_permil[Taxon=='Sylvilagus ']~pach.d18O_mean[Taxon=='Sylvilagus '], data=iso_dat)
summary(nitrogen.lm)
abline(lm(del15N_permil[Taxon=='Sylvilagus ']~pach.d18O_mean[Taxon=='Sylvilagus '], data=iso_dat))
dev.off()
...
C<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del13C_permil*b), color = "brown", data=subset(data0,Taxon=="Sylvilagus sp")) +
...
n<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del15N_permil*b), color = "red", data=subset(data0,Taxon=="Sylvilagus sp")) +
  geom_line(aes(y = pach.d18O), color = "blue", data=subset(data0,Taxon=="Sylvilagus sp")) +
  scale_y_reverse("d18O Neogloboquadrina pachyderma", sec.axis = sec_axis(~ (. - a)/b, name = expression({delta}^15*N~'\u2030'))) +
  scale_x_reverse("Calibrated Years Before Present")+
...
#carbon and climate
plot(del13C_permil[Taxon=='S. audubonii']~pach.d18O[Taxon=='S. audubonii'], data=data0, pch=16)
carbon.lm<-lm(del13C_permil[Taxon=='S. audubonii']~pach.d18O[Taxon=='S. audubonii'], data=data0)
summary(carbon.lm)
abline(lm(del13C_permil[Taxon=='S. audubonii']~pach.d18O[Taxon=='S. audubonii'], data=data0))

#nitrogen and climate
plot(del15N_permil[Taxon=='S. audubonii']~pach.d18O[Taxon=='S. audubonii'], data=data0, pch=16)
carbon.lm<-lm(del15N_permil[Taxon=='S. audubonii']~pach.d18O[Taxon=='S. audubonii'], data=data0)
summary(carbon.lm)
abline(lm(del15N_permil[Taxon=='S. audubonii']~pach.d18O[Taxon=='S. audubonii'], data=data0))
...
C<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del13C_permil*b), color = "brown", data=subset(data0,Taxon=="S. audubonii")) +
...
n<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del15N_permil*b), color = "red", data=subset(data0,Taxon=="S. audubonii")) +
  geom_line(aes(y = pach.d18O), color = "blue", data=subset(data0,Taxon=="S. audubonii")) +
  scale_y_reverse("d18O Neogloboquadrina pachyderma", sec.axis = sec_axis(~ (. - a)/b, name = expression({delta}^15*N~'\u2030'))) +
  scale_x_reverse("Calibrated Years Before Present")+
...
#carbon and climate
plot(del13C_permil[Taxon=='S. bachmani']~pach.d18O[Taxon=='S. bachmani'], data=data0, pch=16)
carbon.lm<-lm(del13C_permil[Taxon=='S. bachmani']~pach.d18O[Taxon=='S. bachmani'], data=data0)
summary(carbon.lm)
abline(lm(del13C_permil[Taxon=='S. bachmani']~pach.d18O[Taxon=='S. bachmani'], data=data0))

#nitrogen and climate
plot(del15N_permil[Taxon=='S. bachmani']~pach.d18O[Taxon=='S. bachmani'], data=data0, pch=16)
carbon.lm<-lm(del15N_permil[Taxon=='S. bachmani']~pach.d18O[Taxon=='S. bachmani'], data=data0)
summary(carbon.lm)
abline(lm(del15N_permil[Taxon=='S. bachmani']~pach.d18O[Taxon=='S. bachmani'], data=data0))
...
C<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del13C_permil*b), color = "brown", data=subset(data0,Taxon=="S. bachmani")) +
...
n<-ggplot(data0, aes(Cal_age, pach.d18O)) +
  geom_line(aes(y = a + del15N_permil*b), color = "red", data=subset(data0,Taxon=="S. bachmani")) +
  geom_line(aes(y = pach.d18O), color = "blue", data=subset(data0,Taxon=="S. bachmani")) +
  scale_y_reverse("d18O Neogloboquadrina pachyderma", sec.axis = sec_axis(~ (. - a)/b, name = expression({delta}^15*N~'\u2030'))) +
  scale_x_reverse("Calibrated Years Before Present")+
